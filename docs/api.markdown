# 接口说明文档
*Document generated by protoc-gen-markdown at 2022/05/10 21:11:46. DO NOT EDIT.* 
...
* 单次任务接口
    * [创建任务]() - [(/api/once_job/create)]()
    * [更新任务]() - [(/api/once_job/update)]()
    * [删除任务]() - [(/api/once_job/delete/job_id)]()
    * [任务列表]() - [(/api/once_job/lists)]()
* 周期任务接口
    * [周期任务列表]() - [(/api/cron_job/lists)]()
    * [周期任务信息]() - [(/api/cron_job/describe/job_id)]()
    * [创建周期任务列表]() - [(/api/cron_job/create)]()
    * [更新周期任务列表]() - [(/api/cron_job/update)]()
    * [删除周期任务列表]() - [(/api/cron_job/delete/job_id)]()
* 任务日志接口
    * [任务运行日志]() - [(/api/job_logs/job_id)]()
<!-- 接口信息 -->
<!-- 切割 -->
# 单次任务接口
<!-- 切割 -->
